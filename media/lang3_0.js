...
audio_show_my_audios='Show my audio files';
...
apps_cancel='Cancel';
apps_catalogue='Applications directory';
...
help_ccform_legal_need_owner='You need to confirm that you are the authorized representative of the right holder of the specified arguable content.';
...
public_want_to_add_admin=['','Are you sure you want to appoint %s as the page administrator?','Are you sure you want to appoint %s as the page administrator?'];
// section = 55; version = 50;
...
mobile_privacy_some_friends='Certain friends';
mobile_privacy_some_friends_list='Certain lists of friends';
